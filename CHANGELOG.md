...
- **Refactored watch command loop**: Extracted `waitWatchTick` helper function to reduce nesting and simplify tick event selection and context cancellation handling in `cmd/watch.go`.
