...
- **Code health refactoring in `cmd/next.go`**: Extracted deeply nested listener loop into a helper function `getInUsePorts` to improve maintainability and readability.
